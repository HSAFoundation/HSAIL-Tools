...
cmake -G "Unix Makefiles" -DBUILD_HSAILASM=$BUILD_HSAILASM -DBUILD_LIBBRIGDWARF=$BUILD_LIBBRIGDWARF -DLLVM_PATH=$LLVM_PATH -DLLVM_SUPPORT_LIB=$LLVM_SUPPORT_LIB_DIR/$BUILD_SUBDIR/LLVMSupport.a -DLIBELF_INCLUDE_DIRS="$LIBELF_PATH:$LIBELF_PATH/../common" -DLIBDWARF_INCLUDE_DIRS=$LIBDWARF_PATH/src -DLIBELF_LIBRARIES=$LIBELF_PATH/$BUILD_SUBDIR/libelf.a -DLIBDWARF_LIBRARIES=$LIBDWARF_PATH/$BUILD_SUBDIR/libdwarf.a -DEXTRA_CFLAGS=$EXTRA_CFLAGS "$@" ../..
cd ../..
