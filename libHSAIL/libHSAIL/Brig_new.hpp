...
typedef uint8_t BrigRound8_t;                               //.defValue=Brig::BRIG_ROUND_NONE
...
>>>>>>> 9a01f314ec53488368d1961748033c56007f0bd2
...
enum BrigTypeX {
    ...
    //.t2s_switch //.t2s_proto="const char* type2str(unsigned type)" //.t2s_arg="type"
    ...
    //.dispatch={ /ARRAY$/ ? "v.visitNone(type)" : /^BRIG_TYPE_([BUSF]|SIG)[0-9]+/ ? "v.template visit< BrigType<$_> >()" : "v.visitNone(type)" }
